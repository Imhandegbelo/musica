          ...
          <div className="flex">
            <div className="flex gap-2n relative">
              ...
              <img
                src={ellipse_2}
                alt=""
                className="w-10 h-10 absolute left-4 z-10"
              />
              <img
                src={ellipse_3}
                alt=""
                className="w-10 h-10 absolute left-8 z-20"
              />
              <img
                src={ellipse_4}
                alt=""
                className="w-10 h-10 absolute left-12 z-30"
              />
              <img
                src={ellipse_5}
                alt=""
                className="w-10 h-10 absolute left-16 z-40"
              />
            </div>
